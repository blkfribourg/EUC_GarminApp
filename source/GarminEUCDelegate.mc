...
class GarminEUCDelegate extends WatchUi.BehaviorDelegate {
    ...
    function onMenu() as Boolean {
        ...
        WatchUi.pushView(menu, new GarminEUCMenu2Delegate(menu,eucBleDelegate,queue,mainView,self), WatchUi.SLIDE_UP );
        return true;
    }
    ...
    function onNextPage() as Boolean{
        ...
        WatchUi.pushView(activityView, new ActivityRecordDelegate(activityView,mainView,self), WatchUi.SLIDE_UP); // Switch to DetailView
